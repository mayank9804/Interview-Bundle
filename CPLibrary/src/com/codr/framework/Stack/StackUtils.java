...
public class StackUtils {
    ...
    /**
     * The next greater element of some element x in an array is the first smaller element that is to the right of x in the same array.
     * @param input
     * @return
     */
    public static List<Integer> computeNextSmallerElements(final List<Integer> input) {
        if (input.isEmpty()) return input;
        AtomicInteger integer = new AtomicInteger(0);
